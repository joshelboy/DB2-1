...
COMMENT ON TABLE db2.hr.countries
    IS 'country table. Contains 25 rows. References with locations table.';

COMMENT ON COLUMN db2.hr.countries.country_id
    IS 'Primary key of countries table.';

COMMENT ON COLUMN db2.hr.countries.country_name
    IS 'Country name';

COMMENT ON COLUMN db2.hr.countries.region_id
...
COMMENT ON TABLE db2.hr.locations
...
COMMENT ON TABLE db2.hr.departments
...
COMMENT ON COLUMN db2.hr.departments.department_id
    IS 'Primary key column of departments table.';

COMMENT ON COLUMN db2.hr.departments.department_name
...
COMMENT ON COLUMN db2.hr.departments.manager_id
...
COMMENT ON COLUMN db2.hr.departments.location_id
...
COMMENT ON COLUMN db2.hr.employees.department_id
...
COMMENT ON TABLE db2.hr.job_history
...
COMMENT ON COLUMN db2.hr.job_history.employee_id
...
COMMENT ON COLUMN db2.hr.job_history.start_date
...
COMMENT ON COLUMN db2.hr.job_history.end_date
